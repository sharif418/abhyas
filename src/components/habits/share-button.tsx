...
/**
 * Share button + overlay — generates a shareable text summary of a habit's
 * progress. Supports WhatsApp share + copy-to-clipboard. Rendered through the
 * unified ResponsiveModal primitive (mobile: bottom sheet, desktop: dialog).
 */
  ...
  return (
    <>
      ...
      <ResponsiveModal
        ...
        title="অগ্রগতি শেয়ার করুন"
        description="আপনার অভ্যাসের অগ্রগতি শেয়ার করুন"
        size="sm"
      >
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-primary/10 via-card to-card p-4">
              ...
              <div className="relative">
                ...
                {stats.isIslamic && (
                  <span className="mt-0.5 inline-block rounded-full bg-islamic/10 px-2 py-0.5 text-[10px] font-bold text-islamic">
                    ইসলামিক অভ্যাস
                  </span>
                )}
